...
const UpdateProduct = () => {
  ...
  useEffect(() => {
    if (productData) {
      ...
      // ✅ Corrected initial URL setup
      setPreviewURL(productData.coverImage.startsWith('http') 
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // ✅ Fix: set new preview URL after successful submission
      setPreviewURL(coverImage.startsWith("http") ? coverImage : `${getBaseUrl()}${coverImage}`);
      refetch();
    } catch (error) {
